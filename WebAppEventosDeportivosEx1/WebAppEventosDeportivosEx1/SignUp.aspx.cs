...
namespace WebAppEventosDeportivosEx1
{
    ...
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        protected void btnSumbit_Click(object sender, EventArgs e)
        {
            ...
            int type = EntityLayer.EventosDeportivosEx1.Util.Constants.ID_USER_NORMAL;
            ...
            messageValidations = new BusinessLayer.EventosDeportivosEx1.User(strConnString).ValidationsDuplicated(user);
            if (messageValidations != string.Empty)
            {
                lblMessage.Text = messageValidations;
                return;
            ...
            user.Password = EntityLayer.EventosDeportivosEx1.Util.Hash.GeneratePasswordHash(password);
            new BusinessLayer.EventosDeportivosEx1.User(strConnString).Save(user);
            lblMessage.Text = "User registered successfully!. Please go to login page.";
        }
        public string UserFieldsRequiredValidations(EntityLayer.EventosDeportivosEx1.User user)
        {
